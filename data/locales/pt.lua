locale = {
  ...
  translation = {
	...
	["Are you sure that you want to sell all these items for {#3af27b|%s} ?"] = "Tem certeza de que deseja vender todos esses itens por {#3af27b|%s} ?",
    ["Are you sure you want to logout?"] = "Você tem certeza que quer sair?",
	["Ask before dropping a container"] = "Perguntar antes de derrubar um container",
    ["Ask before dropping a pokeball"] = "Perguntar antes de derrubar uma pokebola",
	["Attack"] = "Atacar",
    ["Audio"] = "Áudio",
    ["Author"] = "Autor",
	...
	["Choose"] = "Escolher",
	["Choose you pokemon"] = "Escolha seu pokémon",
	...
	["Disable chat mode, allow to walk using ASDW"] = "Desative o modo de bate-papo, permita andar usando ASDW",
    ["Dismount"] = "Desmontar",
	...
	["Do you really want to choose {%s|%s} as your first pokemon?"] = "Você realmente deseja escolher {%s|%s} como seu primeiro Pokémon?",
	["Do you want to buy {%s|%s} for %s pocket coins?"] = "Deseja comprar {%s|%s} por %s pocket coins?",
    ["Don't ask again"] = "Não pergunte de novo",
	["Don't drop"] = "Não derrubar",
	...
	["Enable chat mode"] = "Ativar modo bate-papo",
	...
	["Enter player name"] = "Insira o nome do jogador",
	["Enter the amount of points"] = "Insira a quantidade de pontos",
    ...
    ["Hide Wild Pokemon"] = "Esconder Pokemon Selvagens",
    ...
    ["Host"] = "Host",
    ["Hotkeys"] = "Atalhos",
    ["If you shut down the program, your character might stay in the game.\nClick on {#e2bb5b|'Logout'} to ensure that you character leaves the game properly.\nClick on {#e2bb5b|'Exit'} if you want to exit the program without logging out your character."] = "Se você desligar o programa o seu personagem pode continuar no jogo.\nClique em {#e2bb5b|'Sair'} para assegurar que seu personagem saia do jogo adequadamente.\nClique em {#e2bb5b|'Forçar Saida'} para fechar o programa sem desconectar seu personagem.",
	...
	["List of Pokemon"] = "Lista de Pokemon",
    ["Load"] = "Carregar",
	["Lock"] = "Trancar",
    ["Logging out..."] = "Saindo...",
    ...
    ["Server"] = "Servidor",
	["Set Addon"] = "Escolher Addon",
    ["Set Outfit"] = "Escolher Roupa",
	["Set text"] = "Definir texto",
	["Set label"] = "Definir etiqueta",
    ["Shielding"] = "Defesa",
    ["Show all items"] = "Exibir todos os itens",
	["Show Chat"] = "Exibir Chat",
	...
	["Show first action bar"] = "Exibir barra de ação 1",
	["Show menu"] = "Exibir menu", 
	["Show second action bar"] = "Exibir barra de ação 2",
	...
	["This shortcut key is already in use"] = "Esta tecla de atalho já está em uso",
    ["Title"] = "Título",
    ["Total Price"] = "Preço total",
	["Trade Points"] = "Trocar Pontos",
	...
	["Do you really want to take down this container?"] = "Você quer mesmo derrubar esse recipiente?",
    ["Do you really want to take down this pokeball?"] = "Você quer mesmo derrubar essa pokebola?",
	...
	["Your current points"] = "Seus pontos atuais",
