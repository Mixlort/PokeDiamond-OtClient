...
function onLockActionBarCheckChange(value)
  if value then
    gameRootPanel:recursiveGetChildById('moveBottomPanelTwo'):setVisible(true)
  else
    gameRootPanel:recursiveGetChildById('moveBottomPanelTwo'):setVisible(false)
  end
end
  ...
  if creatureThing then
    ...
    if creatureThing:isLocalPlayer() then
      ...
      if creatureThing:getPosition().z == localPosition.z then
        ...
        menu:addSeparator()
        -- menu:addOption(tr('Select Addon'), function() g_game.talk("!pokeaddon") end)
        -- menu:addOption(tr('Evolve'), function() g_game.talk("!pokeevolve") end)
      end
...
function refreshViewMode()  
  ...
  if classic then  
    ...
    if g_app.isMobile() then
      ...
      gameMapPanel:setZoom(15) --mixlort 17
    end
