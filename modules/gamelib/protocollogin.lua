...
function ProtocolLogin:parseCharacterList(msg)
  ...
  if g_game.getProtocolVersion() > 1010 then
    ...
    for i=1, charactersCount do
      ...
      character.outfit = {type = 129, head = 0, body = 0, legs = 0, feet = 0, addons = 0}
      character.outfit.type = msg:getU16()
      character.outfit.head = msg:getU16()
      character.outfit.body = msg:getU16()
      character.outfit.legs = msg:getU16()
      character.outfit.feet = msg:getU16()
      character.outfit.addons = msg:getU16()
