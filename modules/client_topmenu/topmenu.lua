...
function addLeftButton(id, description, icon, callback, front, index)
  return addButton(id, description, icon, callback, topMenu.centerGameButtonsPanel, false, front, index)
end
...
function addLeftGameButton(id, description, icon, callback, front, index)
  local button = addButton(id, description, icon, callback, topMenu.centerGameButtonsPanel, false, front, index)
  return button
end
